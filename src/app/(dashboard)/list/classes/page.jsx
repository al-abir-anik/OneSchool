...
import { classesData, role } from "@/library/data";
...
const ClassListPage = () => {
  const renderRow = (item) => {
    return (
      ...
      >
        <td className="font-semibold flex items-center gap-4 p-5">{item.name}</td>
        <td className="pl-3">{item.capacity}</td>
        <td className="hidden md:table-cell pl-3">{item.grade}</td>
