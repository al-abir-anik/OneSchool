...
const columns = [
  ...
  },
  {
    header: "Date",
    accessor: "date",
    className: "hidden md:table-cell pl-3",
  },
  {
    header: "Start Time",
    accessor: "startTime",
  ...
  const renderRow = (item) => {
    return (
      ...
      >
        ...
        <td className="pl-2">{item.class}</td>
        <td className="hidden md:table-cell pl-1">{item.date}</td>
        <td className="hidden md:table-cell pl-2">{item.startTime}</td>
        <td className="hidden md:table-cell pl-2">{item.endTime}</td>
        <td>
