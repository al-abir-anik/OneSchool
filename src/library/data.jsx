...
export const calendarEvents = [
  // Monday - May 19, 2025
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 4, 19, 8, 0),
    end: new Date(2025, 4, 19, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 19, 9, 0),
    end: new Date(2025, 4, 19, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 19, 10, 0),
    end: new Date(2025, 4, 19, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 19, 11, 0),
    end: new Date(2025, 4, 19, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 4, 20, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 20, 11, 0),
    end: new Date(2025, 4, 20, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 4, 20, 14, 0),
    end: new Date(2025, 4, 20, 14, 45),
  },
  ...
  // Thursday - May 22
  {
    ...
    end: new Date(2025, 4, 22, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 22, 10, 0),
    end: new Date(2025, 4, 22, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 22, 11, 0),
    end: new Date(2025, 4, 22, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 4, 22, 14, 0),
    end: new Date(2025, 4, 22, 14, 45),
  },
  ...
  // Friday - May 23
  {
    ...
    end: new Date(2025, 4, 23, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 23, 9, 0),
    end: new Date(2025, 4, 23, 9, 45),
  },
  {
    title: "Physics",
    allDay: false,
  ...
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 4, 23, 13, 0),
    end: new Date(2025, 4, 23, 13, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 4, 24, 15, 0),
    end: new Date(2025, 4, 24, 15, 45),
  },
];
